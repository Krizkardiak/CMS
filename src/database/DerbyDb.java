...
public class DerbyDb {
	...
	public String getItems(String query) throws Exception {

		return getItems(query, "n/a");
	}


	public String getItems(String query,boolean defaultStyle) throws Exception {

		if(defaultStyle)
		{
			return getItems(query, "result.xsl");
		}
		else
		{
	...
	public String getItems(String  query,String style) throws Exception {
		...
		try {
			...
			try {
				...
				if (style.equalsIgnoreCase("n/a"))
				{
					xml = resultXml.getResult();
				}
				else
				{
					xml = resultXml.getResult(style);
				}
	...
	public String insert(String  query) {
		...
		String result="Number of rows inserted:";
		Connection con = null;		
		EmbeddedSimpleDataSource ds = new EmbeddedSimpleDataSource();
		String dbName = "simpleMobileDB"; // the name of the database
		ds.setDatabaseName(dbName);
